## Implementation Forum "Data Exchange"

### General Information

This is the repository for the Data Space Implementation Forum "Data Exchange", dealing with the corresponding DSSC Building Blocks.

We are currently meeting biweekly on x-days from hh:mm to hh:mm. Reminders and invitations for new participants will be sent 1-2 days before the meetings. To receive invitations, [please register via this link](https://forms.gle/CUDio2n6nGhgM94X6) and select at least one of the building blocks above. You can propose agenda items by committing changes to the agenda below. [Please also join our Matrix channel](https://matrix.to/#/!lLBhwhnkBFYmBANUjJ:matrix.org?via=matrix.org).
